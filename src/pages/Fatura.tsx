      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-6">
        <div className="w-full max-w-md text-center space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Esta página serve para preencher os dados necessários para a emissão da fatura.
          </p>
          <div className="flex items-start gap-2 text-left bg-muted/50 rounded-lg p-4">
            <Mail className="w-4 h-4 text-muted-foreground mt-0.5 shrink-0" />
            <p className="text-sm text-muted-foreground">
              Aceda através do <strong className="text-foreground">link enviado por email</strong>. Caso não encontre o email, verifique a pasta de spam ou contacte-nos pelo WhatsApp.
            </p>
          </div>
        </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-lg">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          Preencha os dados abaixo para que a fatura possa ser emitida.
        </p>
        <InvoiceForm
          userEmail=""
          registrationId={rid}
        ...
        {valid && (
          <div className="flex items-center gap-2 text-green-600 text-sm font-medium mt-2 animate-in fade-in">
            ...
            Dados guardados com sucesso. Já pode fechar esta página.
          </div>
        )}
      </div>
      <WhatsAppSupportButton />
