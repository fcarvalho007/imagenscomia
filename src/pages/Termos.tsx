...
const Termos = () => (
  <div className="min-h-screen bg-[#060D1A] text-white/80">
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
      <Link to="/" className="inline-flex items-center gap-2 text-sm text-white/40 hover:text-white/70 transition-colors mb-10">
        <ArrowLeft className="w-4 h-4" />
        Voltar à página principal
      </Link>

      <h1 className="font-heading text-3xl sm:text-4xl font-bold text-white mb-10">Termos e Condições</h1>
      ...
      <div className="space-y-8 text-[15px] leading-relaxed">
        <Section n="1" title="Identificação e âmbito">
          ...
          <ul className="list-none space-y-1 mt-3">
            ...
            <li>E-mail: <a href="mailto:frederico.carvalho@digitalfc.pt" className="text-blue-400 hover:underline">frederico.carvalho@digitalfc.pt</a></li>
        ...
        <Section n="6" title="Reembolsos e direito de livre resolução">
          ...
          <p>Para pedidos de esclarecimento sobre reembolsos e faturação deve ser usado o contacto: <a href="mailto:frederico.carvalho@digitalfc.pt" className="text-blue-400 hover:underline">frederico.carvalho@digitalfc.pt</a>.</p>
        </Section>
        ...
        <Section n="12" title="Contacto">
          ...
          <p><a href="mailto:frederico.carvalho@digitalfc.pt" className="text-blue-400 hover:underline">frederico.carvalho@digitalfc.pt</a> | +351 915 015 508 (WhatsApp)</p>
        </Section>
      </div>
    </div>
