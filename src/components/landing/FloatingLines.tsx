...
export default function FloatingLines({
  ...
  const getCount = (waveType: string): number => {
  ...
  const getDist = (waveType: string): number => {
  ...
  const topLD = enabledWaves.includes("top") ? getDist("top") * 0.01 : 0.01;
  const midLD = enabledWaves.includes("middle") ? getDist("middle") * 0.01 : 0.01;
  const botLD = enabledWaves.includes("bottom") ? getDist("bottom") * 0.01 : 0.01;
