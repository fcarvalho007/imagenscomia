...
const OWNER_TEST_MOBILE = "915 015 508";

const stateMessages: Record<string, string> = {
  sent: "Teste enviado.",
  duplicate: "Este teste já tinha sido enviado.",
  ...
  return (
    <div className="mb-5 rounded-lg border bg-white p-4">
      ...
      <p className="mt-1 text-sm text-slate-600">
        ...
        {adminEmail ? ` (${adminEmail})` : ""} e o telemóvel {OWNER_TEST_MOBILE}. Não é possível indicar outro contacto.
      </p>
