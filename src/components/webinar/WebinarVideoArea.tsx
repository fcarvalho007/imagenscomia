...
const CountdownBlock = ({ value, label }: { value: number; label: string }) => (
  <div className="flex flex-col items-center">
    <span className="font-heading font-bold text-[28px] sm:text-[36px] leading-none text-ink-900 tabular-nums">
    ...
    <div className="aspect-video rounded-xl bg-gradient-to-br from-ink-900 via-[#0f1b33] to-ink-900 flex items-center justify-center mb-6 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 text-[14px] font-medium text-white/70 hover:text-white transition-colors border border-white/15 rounded-lg px-4 py-2 hover:border-white/30"
        >
