...
export default function RecursosUpsell({ hasMasterclass }: RecursosUpsellProps) {
  if (hasMasterclass) {
    return (
      <div className="bg-[hsl(var(--green-50))] border border-[hsl(var(--green-100))] rounded-2xl p-6 text-center">
        <div className="w-10 h-10 bg-[hsl(var(--green-100))] rounded-full flex items-center justify-center mx-auto mb-3">
          <Check size={20} className="text-[hsl(var(--green-600))]" />
        </div>
        <p className="font-semibold text-[hsl(var(--ink-900))]">Masterclass incluída no teu plano ✓</p>
        <p className="text-sm text-[hsl(var(--ink-500))] mt-1">
