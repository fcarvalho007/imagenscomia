...
export default function RecursosLogin({ onAuthed }: RecursosLoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      sessionStorage.setItem("recursos_email", email.toLowerCase().trim());
        ...
        <div className="bg-[hsl(var(--white))] rounded-2xl border border-[hsl(var(--border))] shadow-sm p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-[hsl(var(--ink-700))] font-medium">
                O teu email
              </Label>
              <Input
                id="email"
                  ...
                  {error === "not_found" && (
                    <>
                      ...
                      <p className="text-[hsl(var(--ink-500))] mt-1">
                        ...
                        <a href="/" className="underline text-[hsl(var(--blue-600))]">
                  ...
                  {error === "not_paid" && (
                    <>
                      ...
                      <p className="text-[hsl(var(--ink-500))] mt-1">
                        ...
                        <a href="/gravacao" className="underline text-[hsl(var(--blue-600))]">
                          Comprar acesso →
                        </a>
                      </p>
                    </>
