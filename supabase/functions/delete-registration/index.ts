...
const ALLOWED_ADMIN_EMAIL = "fredericodigital@gmail.com";
...
serve(async (req) => {
  ...
  try {
    const adminEmail = req.headers.get("x-crm-admin-email")?.toLowerCase().trim();
    ...
    console.log(`🗑️ Deleted registration ${registration_id}`);
