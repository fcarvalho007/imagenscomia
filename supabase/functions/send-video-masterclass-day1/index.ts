...
<div style="max-width:600px;margin:0 auto;background:#ffffff;">
  <div style="background:linear-gradient(135deg,#064e3b 0%,#16a34a 100%);padding:36px 28px 28px;text-align:center;">
    ...
    <h1 style="color:#ffffff;font-size:22px;font-weight:700;margin:0;line-height:1.3;">Os teus recursos estão prontos</h1>
  </div>
  <div style="padding:32px 28px;">
    <p style="color:#333;font-size:16px;line-height:1.7;margin:0 0 16px;">Olá ${fname},</p>
    <p style="color:#333;font-size:16px;line-height:1.7;margin:0 0 16px;">A gravação completa e todos os materiais da Masterclass já estão disponíveis.</p>
    <div style="text-align:center;margin:28px 0;">
      <a href="https://imagenscomia.com/recursos-video" style="display:inline-block;background:#16a34a;color:#fff;padding:14px 32px;border-radius:8px;font-weight:700;text-decoration:none;font-size:15px;">Aceder aos meus recursos →</a>
    </div>
  ...
  try {
    ...
    for (const reg of toSend) {
      ...
      try {
        ...
        const subject = (tpl?.subject ?? "{{fname}}, a gravação e os recursos estão prontos").replace(/\{\{fname\}\}/g, fname);
