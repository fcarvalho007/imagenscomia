...
<div style="max-width:600px;margin:0 auto;background:#ffffff;">
  ...
  <div style="padding:32px 28px;">
    ...
    <p style="color:#333;font-size:16px;line-height:1.6;margin:0 0 16px;">Este é o último email que te envio sobre a sessão "Cria Vídeo Profissional com IA".</p>
    <p style="color:#333;font-size:16px;line-height:1.6;margin:0 0 28px;">Se decidiste que não é para ti neste momento, tudo bem — sem pressão. Mas se ainda tens interesse, aqui fica o resumo do que podes obter:</p>
  ...
  try {
    ...
    for (const reg of toSend) {
      ...
      try {
          ...
          const subject = (tpl?.subject ?? "Último email, {{fname}} — Premium Pass e Masterclass").replace(/\{\{fname\}\}/g, fname);
