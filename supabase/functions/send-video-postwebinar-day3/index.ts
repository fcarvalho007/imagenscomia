...
<div style="max-width:600px;margin:0 auto;background:#ffffff;">
  ...
  <div style="background:linear-gradient(135deg,#1e1b4b 0%,#312e81 50%,#4338ca 100%);padding:36px 28px 28px;text-align:center;">
    ...
    <h1 style="color:#ffffff;font-size:22px;font-weight:700;margin:0;line-height:1.3;">Último email sobre o Premium Pass</h1>
  </div>

  <!-- Body -->
  <div style="padding:32px 28px;">
    <p style="color:#333;font-size:16px;line-height:1.6;margin:0 0 16px;">Olá ${fname},</p>
    <p style="color:#333;font-size:16px;line-height:1.6;margin:0 0 16px;">Este é o último email que te envio sobre o Premium Pass da sessão "Cria Vídeo Profissional com IA".</p>
    <p style="color:#333;font-size:16px;line-height:1.6;margin:0 0 28px;">Se ainda tens interesse em rever a sessão completa, aplicar os exercícios e usar as ferramentas que partilhei, aqui fica o resumo do que inclui:</p>
